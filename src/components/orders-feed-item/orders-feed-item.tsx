...
const OrdersFeedItem = ({ createdAt, ingredients, name, number, status, updatedAt, _id, displayStatus }: IOrdersFeedItem) => {
    ...
    return (
        <div className={`${styles.ordersFeedItemContainer} p-6`}>
            <div className={styles.ordersFeedItemHeading}>
            ...
            <div className={styles.ordersFeedItemDetails}>
                ...
                <div className={styles.ordersFeedItemCost}>
